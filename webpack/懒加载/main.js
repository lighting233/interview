(() => {
    ...
    //todo 2.创建promise，发起jsonp请求
    require.e = (chunkId) => {
        let promises = [];
        require.f.j(chunkId, promises);
        //todo 7.等这个promise数组里的promise都成功之后,执行 then 方法加载模块
    ...
    //todo 3.通过jsonp异步加载chunkId,也就是hello这个代码块
